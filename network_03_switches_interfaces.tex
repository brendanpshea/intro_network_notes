    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.45\textwidth}
            ...
            \begin{alertblock}{Key Components}
                \small
                \textbf{Laser/LED}: Converts electrical → light \\
                \textbf{Photodetector}: Converts light → electrical \\
...
\begin{frame}{Table: Types of Transceivers}
    \begin{center}
        \small
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{block}{Key Abbreviations}
                \small
                \textbf{MMF}: Multimode Fiber \\
                \textbf{SMF}: Single-mode Fiber \\
                \textbf{DAC}: Direct Attach Cable
            \end{block}
        \end{column}
        \begin{column}{0.48\textwidth}
