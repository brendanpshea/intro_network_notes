...
\newcommand{\icondatabase}[1][0.6cm]{\resizebox{#1}{!}{\faIcon{database}}} % Fixed definition
\newcommand{\icondog}[1][0.6cm]{\resizebox{#1}{!}{\faIcon{dog}}} % Agent Snoopy
\newcommand{\iconcat}[1][0.6cm]{\resizebox{#1}{!}{\faIcon{cat}}} % Hacker Cat

% Document info
\title[Module 9.0]{Module 9.0: Security Concepts}
