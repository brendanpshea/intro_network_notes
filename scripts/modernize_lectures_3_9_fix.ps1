...
$review8 = @"\begin{frame}{Review: From Module 7 to Network Operations}
    \begin{itemize}
        \item Module 7 focused on application services, availability, and resilience design.
        \item Module 8 shifts to operating and observing production networks.
        \item Strong monitoring and documentation make reliability measurable and repeatable.
    \end{itemize}
\end{frame}"@
...
$review9 = @"\begin{frame}{Review: Operations Foundations from Module 8}
    \begin{itemize}
        \item Module 8 established documentation, telemetry, and monitoring workflows.
        \item Module 9 builds on that visibility to identify and mitigate security threats.
        \item Effective defense combines technical controls with disciplined operations.
    \end{itemize}
\end{frame}"@
